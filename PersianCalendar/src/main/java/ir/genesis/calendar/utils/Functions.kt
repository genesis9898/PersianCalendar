package ir.genesis.calendar.utils
...
import ir.genesis.calendar.entities.CalendarTypeItem
import ir.genesis.calendar.entities.CityItem
import ir.genesis.calendar.service.ApplicationService
import ir.genesis.calendar.service.BroadcastReceivers
import ir.genesis.calendar.service.UpdateWorker
...
val Context.appMainconfig: SharedPreferences
    get() = getSharedPreferences("mainconfig",0);
